    ...
    <div id="carouselExampleInterval" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                <img src="  <?php echo _WEB_ROOT_ ?>/Uploads/Banner/<?php echo $Carousel[0]["hinhAnh"] ?>"
                    class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item" data-bs-interval="2000">
                <img src="<?php echo _WEB_ROOT_ ?>/Uploads/Banner/<?php echo $Carousel[1]["hinhAnh"] ?>"
                    class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
                <img src="  <?php echo _WEB_ROOT_ ?>/Uploads/Banner/<?php echo $Carousel[2]["hinhAnh"] ?>"
                    class="d-block w-100" alt="..." />
            </div>
        </div>
    </div>
