        ...
        <form action="<?php echo _WEB_ROOT_ ?>/Admin/UpdateArticle" method="post" enctype="multipart/form-data">
                ...
                <div class="row p-2 mt-1 border border-secondary">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" id="thanhvien">
                            ...
                            <input type="text" class="form-control" id="" required="true" name="name_gvhd<?php echo $i; ?>" value="<?php echo $list_Gvhd[$i - 1]['hoTen']; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row  p-2 border border-secondary">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" spellcheck="false" name="name_MB<?php echo $i ?>" class="form-control" required id="" value="<?php echo $member[$i - 1]['hoTen'] ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="article_type" id="" class="form-control">
                    <?php
                    $array = array('Xuất sắc', 'Tốt', 'Khá', 'Đạt', 'Không đạt');
            ...
            <div class="form-group">
                ...
                <input type="text" name="kinhPhi" id="" class="form-control" required value="<?php echo number_format($dataArticleDetail[0]['kinhPhi']); ?>">
            </div>
            <div class="form-group">
